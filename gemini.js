...
**זה הכלל הראשון! לפני כל דבר אחר!**

**חפש את המילה "זיכוי" במסמך!**

**אם אתה רואה "זיכוי" → זו חשבונית זיכוי!**

דוגמאות:
- "חשבונית זיכוי" → חשבונית זיכוי ✓
- "חשבונית מס זיכוי" → חשבונית זיכוי ✓
- "זיכוי" → חשבונית זיכוי ✓
- "מס זיכוי" → חשבונית זיכוי ✓
- "Credit Note" → חשבונית זיכוי ✓
- "Credit Invoice" → חשבונית זיכוי ✓

**כלל פשוט:**
המילה "זיכוי" או "Credit" = חשבונית זיכוי!

**חובה עבור חשבונית זיכוי:**
1. document_type: "credit_invoice"
2. הסכום שלילי: "-256.50"
3. notes: "חשבונית זיכוי"

**⚠️ אזהרה: "זיכוי" = חשבונית זיכוי, לא חשבונית רגילה!**
...
5. **⚠️ CRITICAL - הנחות (DISCOUNTS):**
   - אם יש שורה "הנחה" או "הנחה %" אחרי מוצר - **השתמש במחיר אחרי ההנחה!**
   - דוגמה: מוצר ₪10.00 ואחריו "הנחה -24%" = המחיר הסופי ₪7.60
   - **קח את המחיר הסופי (אחרי הנחה), לא את המחיר המקורי!**
   - אם רואה מחיר מקורי ומחיר מוזל - קח את המוזל
6. **⚠️ CRITICAL - אל תמציא מוצרים!**
   - חלץ **רק** מוצרים שאתה רואה בפועל בחשבונית
   - אל תנחש, אל תמציא, אל להוסיף מוצרים שלא קיימים
   - אם לא בטוח בשם מוצר - **דלג עליו** במקום להמציא
7. **⚠️ CRITICAL: אם אותו מוצר מופיע במספר שורות - צבור את הכמויות למוצר אחד!**
...
8. **מקסימום 50 מוצרים שונים** - אם יש יותר מוצרים שונים, צבור דומים וקח את החשובים
